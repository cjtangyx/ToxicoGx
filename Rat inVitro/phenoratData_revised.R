...
conversion <- read.csv("data/conversions_rat.csv")
...
converted <- merge(need_conversion,conversion,by.x="BARCODE",by.y="X")
...
#Rearrange columns
all_rat_attribute <- all_rat_attribute[,c(2,	3,	4,	5,	6,	29,	17,	18,	30,	19,	16,	25,	1,	9,	10,	20,	21,	32,	11,	12,	13,	7,	8,	33,	34,	14,	15)]
...
write.csv(all_ratattribute,"all_ratattribute_v3.csv")
